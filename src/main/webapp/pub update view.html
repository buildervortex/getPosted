...
<head>
    ...
    <link rel="stylesheet" href="css/pub update.css">
...
<body>
    <nav>
      ...
      <br>
    <h1 class="page-heading">Update your publication</h1>
    ...
    <footer class="containerSP"> 
        <p>© 2024 Copyright getpostedpublications.com | All Rights Reserved | <b>Get:::<sub>/</sub>>osted <sup><sup>TM</sup></sup></b></p>
